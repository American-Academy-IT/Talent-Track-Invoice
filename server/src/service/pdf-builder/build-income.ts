...
const drawRefundPolicy = (doc: PDFKit.PDFDocument, contract: string) => {
  ...
  if (contract === 'EXAMS') {
    ...
    const rule1 = '1.قبل بداية الدورة يسترد 75% من قيمه المصروفات';
    const rule2 = '2.بعد نهاية الأسبوع الأول من الدراسة يسترد 60% من قيمه المصروفات';
    const rule3 = '3.بعد الأسبوع الأول لا يسترد أي مبلغ';
    const rule4 =
      '4.جديه الحجز بجميع الدورات لا ترد في حاله انسحاب الدارس نهائيا اثناء او قبل بداية الدورة';
